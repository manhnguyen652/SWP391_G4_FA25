...
<head>
    ...
    <style>
        ...
        .account-sidebar { border: 1px solid #ddd; border-radius: 6px; overflow: hidden; margin-bottom: 20px; }
        ...
        .account-content { border: 1px solid #ddd; border-radius: 6px; padding: 25px; }
        .btn { background-color: #62ab00; color: #fff; border: none; padding: 8px 20px; border-radius: 4px; cursor: pointer; }
                        ...
                        <div class="account-sidebar">
                            <ul>
                                <li class="${param.section == null || param.section == 'orders' ? 'active' : ''}">
                                    <a href="my-account.jsp?section=orders"><i class="fa fa-shopping-cart"></i> Orders</a>
                                </li>
                                <li class="${param.section == 'address' ? 'active' : ''}">
                                    <a href="my-account.jsp?section=address"><i class="fa fa-map-marker"></i> Address</a>
                                </li>
                                <li class="${param.section == 'details' ? 'active' : ''}">
                                    <a href="my-account.jsp?section=details"><i class="fa fa-user"></i> Account Details</a>
                                </li>
                                <li>
                    ...
                    <div class="col-lg-9 col-md-8">
                        <div class="account-content">
                            <%
                                ...
                                if (section == null || section.equals("orders")) {
                            %>
                            ...
                            <% } else if (section.equals("order-detail")) { %>
                                <jsp:include page="my-account-order-detail.jsp"></jsp:include>
                            <% } else { %>
                                <jsp:include page="my-account-orders.jsp"></jsp:include>
                            <% } %>
                        </div>
