...
<html>
    <head>
        ...
        <link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/common/footer.css">
                                ...
                                <div class="main-navigation flex-lg-right">
                                    <div class="cart-widget">
                                        <div class="login-block">
                                            ...
                                            <span>  </span><a href="${pageContext.request.contextPath}/customer/register.jsp">Đăng ký</a>
                                        </div>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Số điện thoại</label>
                                        <input type="number" class="form-control" id="exampleInputNumber" 
                                               aria-describedby="emailHelp" placeholder="Nhập số điện thoại..." required="required">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nhập lại mật khẩu</label>
                                        <input type="password" class="form-control" id="exampleInputResetPassword" 
