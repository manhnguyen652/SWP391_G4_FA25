...
// SỬA 1: Thêm import bị thiếu cho SQLException
...
public class AccountDAO {
    ...
    public Account checkAccountExist(String email) {
        ...
        // SỬA 2: Đổi cách lấy connection cho đúng với file DBConnect.java của bạn
        try (Connection conn = new DBConnect().connection;
